...
function Message({ Image, Username, Message }) {
    ...
    const ImageView = <img src={Image} className={User.Username === Username ? 
        'rounded-circle mr-2' : 'rounded-circle ml-2'} alt="Profile" height={40} width={40} 
        ...
        <div className="row animated fadeIn delay-500ms pt-1 align-items-center">
            ...
            <div className="col">
                <div className={User.Username === Username ? 'row justify-content-end' : 'row'}>
                    <p className={User.Username === Username ? 
                        text + 'mr-0-md mr-1 font-weight-bold' : text + 'ml-1 font-weight-bold'}>{Username}</p>
                </div>
                <div className={User.Username === Username ? 'row justify-content-end' : 'row'}>
